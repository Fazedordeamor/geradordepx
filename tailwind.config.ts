...
export default {
  ...
  theme: {
  	extend: {
        ...
        'geometry-glide': {
          '0%': { transform: 'translate(-55%, -45%) rotate(-8deg) scale(0.95)' },
          '50%': { transform: 'translate(-45%, -55%) rotate(8deg) scale(1.05)' },
          '100%': { transform: 'translate(-55%, -45%) rotate(-8deg) scale(0.95)' }
        },
        'zoom-through': {
